...
cat(sprintf(
  paste0(
    ...
    'var families=["palette-red","palette-lapis","palette-ochre","palette-teal","palette-green","palette-violet"];',
    'if(!families.some(function(cls){return document.body.classList.contains(cls);})){document.body.classList.add("palette-%s");}',
    '});</script>'
  ),
  params$family
))
...
cat(sprintf(
  paste0(
    '<script>document.addEventListener("DOMContentLoaded",function(){',
    'var presets=["preset-study","preset-structural","preset-adobe","preset-midnight"];',
    'if(!presets.some(function(cls){return document.body.classList.contains(cls);})){document.body.classList.add("preset-%s");}',
    '});</script>'
  ),
  params$preset
))
